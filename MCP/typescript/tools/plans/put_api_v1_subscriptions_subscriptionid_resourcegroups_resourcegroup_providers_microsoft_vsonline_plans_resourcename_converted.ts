...
function getPut_Api_V1_Subscriptions_Subscription_Id_Resource_Groups_Resource_Group_Providers_Microsoft_Vs_Online_Plans_Resource_NameHandler(config: APIConfig): (ctx: any, request: MCPRequest) => Promise<MCPToolResult> {
    ...
    if (args.properties !== undefined) {
        queryParams.push(`properties=${args.properties}`);
            ...
            const url = `${config.baseUrl}/api/v2/put_api_v1_subscriptions_subscription_id_resource_groups_resource_group_providers_microsoft_vs_online_plans_resource_name${queryString}`;
...
function createPut_Api_V1_Subscriptions_Subscription_Id_Resource_Groups_Resource_Group_Providers_Microsoft_Vs_Online_Plans_Resource_NameTool(config: APIConfig): Tool {
    return {
        definition: {
            name: "put_api_v1_subscriptions_subscription_id_resource_groups_resource_group_providers_microsoft_vs_online_plans_resource_name",
        ...
        handler: getPut_Api_V1_Subscriptions_Subscription_Id_Resource_Groups_Resource_Group_Providers_Microsoft_Vs_Online_Plans_Resource_NameHandler(config)
    };
}
...
export {
    ...
    Tool,
    ToolDefinition,
    getPut_Api_V1_Subscriptions_Subscription_Id_Resource_Groups_Resource_Group_Providers_Microsoft_Vs_Online_Plans_Resource_NameHandler,
    createPut_Api_V1_Subscriptions_Subscription_Id_Resource_Groups_Resource_Group_Providers_Microsoft_Vs_Online_Plans_Resource_NameTool
};