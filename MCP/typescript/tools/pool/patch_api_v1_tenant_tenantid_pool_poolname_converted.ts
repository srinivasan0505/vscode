...
function getPatch_Api_V1_Tenant_Tenant_Id_Pool_Pool_NameHandler(config: APIConfig): (ctx: any, request: MCPRequest) => Promise<MCPToolResult> {
    ...
    if (args.domainUserCredentials !== undefined) {
        queryParams.push(`domainUserCredentials=${args.domainUserCredentials}`);
            ...
            const url = `${config.baseUrl}/api/v2/patch_api_v1_tenant_tenant_id_pool_pool_name${queryString}`;
...
function createPatch_Api_V1_Tenant_Tenant_Id_Pool_Pool_NameTool(config: APIConfig): Tool {
    return {
        definition: {
            name: "patch_api_v1_tenant_tenant_id_pool_pool_name",
        ...
        handler: getPatch_Api_V1_Tenant_Tenant_Id_Pool_Pool_NameHandler(config)
    };
}
...
export {
    ...
    Tool,
    ToolDefinition,
    getPatch_Api_V1_Tenant_Tenant_Id_Pool_Pool_NameHandler,
    createPatch_Api_V1_Tenant_Tenant_Id_Pool_Pool_NameTool
};