...
function getDelete_Api_V1_Geneva_Actions_Vnet_Pool_DefinitionsHandler(config: APIConfig): (ctx: any, request: MCPRequest) => Promise<MCPToolResult> {
    ...
    if (args.logicalSkus !== undefined) {
        queryParams.push(`logicalSkus=${args.logicalSkus}`);
            ...
            const url = `${config.baseUrl}/api/v2/delete_api_v1_geneva_actions_vnet_pool_definitions${queryString}`;
...
function createDelete_Api_V1_Geneva_Actions_Vnet_Pool_DefinitionsTool(config: APIConfig): Tool {
    return {
        definition: {
            name: "delete_api_v1_geneva_actions_vnet_pool_definitions",
        ...
        handler: getDelete_Api_V1_Geneva_Actions_Vnet_Pool_DefinitionsHandler(config)
    };
}
...
export {
    ...
    Tool,
    ToolDefinition,
    getDelete_Api_V1_Geneva_Actions_Vnet_Pool_DefinitionsHandler,
    createDelete_Api_V1_Geneva_Actions_Vnet_Pool_DefinitionsTool
};