...
func CreatePost_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_microsoft_vsonline_plans_resourcename_writecodespacesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_v1_subscriptions_subscriptionId_resourceGroups_resourceGroup_providers_Microsoft_VSOnline_plans_resourceName_writeCodespaces",
		mcp.WithDescription(""),
