...
func Delete_api_v1_genevaactions_configuration_target_keyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_api_v1_genevaactions_configuration_target_keyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_GenevaActions_Configuration_target_key",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_v1_genevaactions_configuration_target_keyHandler(cfg),
	}
}
