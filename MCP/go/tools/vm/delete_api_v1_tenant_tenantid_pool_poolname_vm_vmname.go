...
func Delete_api_v1_tenant_tenantid_pool_poolname_vm_vmnameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_api_v1_tenant_tenantid_pool_poolname_vm_vmnameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_tenant_tenantId_pool_poolName_Vm_vmName",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_v1_tenant_tenantid_pool_poolname_vm_vmnameHandler(cfg),
	}
}
