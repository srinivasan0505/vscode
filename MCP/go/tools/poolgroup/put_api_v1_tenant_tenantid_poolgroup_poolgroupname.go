...
func Put_api_v1_tenant_tenantid_poolgroup_poolgroupnameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreatePoolGroupBody
...
func CreatePut_api_v1_tenant_tenantid_poolgroup_poolgroupnameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_v1_tenant_tenantId_PoolGroup_poolGroupName",
		mcp.WithDescription(""),
		...
		mcp.WithNumber("region", mcp.Required(), mcp.Description("")),
		mcp.WithObject("tags", mcp.Description("")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Put_api_v1_tenant_tenantid_poolgroup_poolgroupnameHandler(cfg),
	}
}
