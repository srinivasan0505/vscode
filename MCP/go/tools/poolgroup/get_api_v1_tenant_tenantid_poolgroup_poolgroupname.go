...
func Get_api_v1_tenant_tenantid_poolgroup_poolgroupnameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.PoolGroupResult
...
func CreateGet_api_v1_tenant_tenantid_poolgroup_poolgroupnameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_api_v1_tenant_tenantId_PoolGroup_poolGroupName",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_api_v1_tenant_tenantid_poolgroup_poolgroupnameHandler(cfg),
	}
}
