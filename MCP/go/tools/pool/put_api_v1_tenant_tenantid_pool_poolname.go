...
func Put_api_v1_tenant_tenantid_pool_poolnameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreatePut_api_v1_tenant_tenantid_pool_poolnameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_api_v1_tenant_tenantId_Pool_poolName",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Put_api_v1_tenant_tenantid_pool_poolnameHandler(cfg),
	}
}
