...
func Delete_api_v1_tenant_tenantid_pool_poolnameHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_api_v1_tenant_tenantid_pool_poolnameTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_tenant_tenantId_Pool_poolName",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_v1_tenant_tenantid_pool_poolnameHandler(cfg),
	}
}
