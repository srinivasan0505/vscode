...
func CreatePost_api_v1_subscriptions_subscriptionid_resourcegroups_resourcegroup_providers_github_network_resourcetype_resourcename_resourcedeletioncompletedTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_api_v1_subscriptions_subscriptionId_resourceGroups_resourceGroup_providers_GitHub_Network_resourceType_resourceName_resourceDeletionCompleted",
		mcp.WithDescription(""),
