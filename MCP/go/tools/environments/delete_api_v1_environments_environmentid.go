...
func Delete_api_v1_environments_environmentidHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDelete_api_v1_environments_environmentidTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_api_v1_Environments_environmentId",
		mcp.WithDescription(""),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Delete_api_v1_environments_environmentidHandler(cfg),
	}
}
